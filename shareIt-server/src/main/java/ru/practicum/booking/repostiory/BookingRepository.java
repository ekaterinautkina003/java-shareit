package ru.practicum.booking.repostiory;
...
public interface BookingRepository extends CrudRepository<Booking, Long> {
  ...
  List<Booking> findBookingByBookerIdAndStatusOrderByStartDesc(
          Long bookerId,
          String status,
          Pageable pageable
  );
  ...
  List<Booking> findBookingsByItem_OwnerIdAndStatusOrderByStartDesc(
          Long ownerId,
          String status,
          Pageable pageable
  );
